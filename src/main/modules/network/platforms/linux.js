...
/**
 * Linux platform-specific network operations
 */
class LinuxNetworkChecker {
    /**
     * Check if a domain is accessible on Linux using ping
    ...
    static async checkDomainStatus(domain) {
        console.log("=== Linux Network Check ===");
            ...
            return new Promise((resolve) => {
                ...
                ping.on("close", (code) => {
                    ...
                    if (code === 0) {
                        ...
                        } else if (output.includes("Network is unreachable")) {
                            errorMessage = "网络不可达";
...
module.exports = LinuxNetworkChecker;
